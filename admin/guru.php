...
<!--heder end here-->
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Guru</li>
</ol>
...
$per_hal=10;
$jumlah_record=mysql_query("SELECT COUNT(*) from guru");
...
<div class="agile-grids">	
				...
				<form action="edit_guru.php" method="post">
					...
					<tbody>
						...
						mysql_select_db("guru_wp");
						$nomor = 0;
						$tampil = mysql_query("select * from guru limit $start, $per_hal");
						 while ($data = mysql_fetch_array($tampil)) {
						   ?>
							   ...
							   <td><?php echo $nomor=$nomor+1; ?></td>
								 ...
								 <td><?php echo "<a href=edit_guru.php?nik=$data[nik]>Edit</a>" ?></td>
								 <td><?php echo "<a href=delete_guru.php?nik=$data[nik]>Delete</a>" ?></td>
							   </tr>
						 <?php } ?>
					</tbody>
				  </table>
