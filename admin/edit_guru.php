                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="checkbox-inline">
                                        <label>
                                            <input type="checkbox" name="jk" value="Laki-Laki" <?php if ($jk == "Laki-Laki"): ?> checked="" <?php endif ?> "">Laki-Laki
                                        </label>
                                    </div>
                                    <div class="checkbox-inline">
                                        <label>
                                            <input type="checkbox" name="jk" value="Perempuan" <?php if ($jk == "Perempuan"): ?> checked="" <?php endif ?> "">Perempuan
                                        </label>
                                    </div>
                                </div>
                            </div>
