  	    ...
  	    <div class="tab-content">
			<div class="tab-pane active" id="horizontal-form">			
				...
				<h3 align="center">Perhitungan Vektor</h3>		
					...
					<table id="myTable" border="1" width="80%" align="center">										
						...
						<?php
							...
							<tr>
									<td>
										<input name="n" id="no" value="<?php echo $nomor=$nomor+1; ?>">
									</td>
									<td>
										<input name="nik" id="nik" value="<?php echo $data['nik']; ?>">
									</td>
									<td>
										<input name="nama" id="nama" value="<?php echo $data['nama']; ?>">
									</td>
									<td>
										<input name="hasil" id="hasil" value="<?php echo $hasil; ?>">
									</td>
							</tr>
							<?php
							}
				...
				if(isset($_POST['submit'])){
					...
					$sql   = "INSERT INTO alternatif (nik,nama) VALUES ";
