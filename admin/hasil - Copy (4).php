...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Hasil</li>
</ol>
...
<!--pilih bobot-->
  <div class="grid-form1">
		...
		<div class="tab-content" id="print-area-2" class="print-area">
			...
			<h4 align="center">Bobot yang di Pilih :
					...
					if (isset($_POST['submit'])) {
						...
						$sql = "INSERT INTO bobot (date, c1, c2, c3, c4, c5) values (NOW(),'$bobot_c1','$bobot_c2','$bobot_c3','$bobot_c4','$bobot_c5')";
					...
					<table border="1" width="80%" align="center">
						...
						<tbody>
						   <?php
							...
							<?php }
							$sql11 = "INSERT INTO alternatif (date, nik, nama) values (NOW(),'$nik','$nama')";
		...
		<div><a class="btn btn-primary" href="javascript:printDiv('print-area-2');">Print</a></div>
  </div>
